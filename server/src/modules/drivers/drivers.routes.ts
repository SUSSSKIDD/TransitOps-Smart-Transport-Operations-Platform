...
router.post('/', authorize(Role.FLEET_MANAGER, Role.SAFETY_OFFICER), validate(CreateDriverSchema), driversController.create)
router.put('/:id', authorize(Role.FLEET_MANAGER, Role.SAFETY_OFFICER), validate(UpdateDriverSchema), driversController.update)
